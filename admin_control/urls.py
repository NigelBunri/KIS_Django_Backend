...
urlpatterns = [
    ...
    path(
        ...
        AdminUserScheduleViolationDeletionView.as_view(),
        name="admin-user-schedule-violation-deletion",
    ),
    path("users/<str:user_id>/violations/", AdminUserViolationsView.as_view(), name="admin-user-violations"),
