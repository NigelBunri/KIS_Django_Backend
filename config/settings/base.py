...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "anon": _env_throttle_rate("THROTTLE_ANON", dev_default="6000/min", prod_default="600/min"),
        "user": _env_throttle_rate("THROTTLE_USER", dev_default="6000/min", prod_default="3000/min"),
        "admin_burst": _env_throttle_rate("THROTTLE_ADMIN_BURST", dev_default="6000/min", prod_default="300/min"),
        "admin_sustained": _env_throttle_rate("THROTTLE_ADMIN_SUSTAINED", dev_default="6000/day", prod_default="5000/day"),
